...
await Promise.all(["index.html", "product.html", "roadmap.html", "login.html", "styles.css", "app.js", "auth.js"].map((file) => fs.copyFile(path.join(root, file), path.join(client, file))));
