...
await Promise.all(["index.html", "product.html", "roadmap.html", "integration-map.html", "workflow.html", "evidence.html", "security.html", "plans.html", "login.html", "styles.css", "app.js", "auth.js", "aipi-logo.svg"].map((file) => fs.copyFile(path.join(root, file), path.join(client, file))));
